...
# ==== Read rosbag ====
bag = rosbag.Bag('mapa_sem_filtro.bag')  # adjust path if needed
...
# === Save Figures ===
plt.savefig('plots/mapa_contorno_sem_filtro.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.savefig('plots/mapa_contorno_sem_filtro.pgf', format='pgf', bbox_inches='tight', facecolor='white')
